			...
			<div id="med-right">
				<div class="table-responsive" style="border:1px solid #ccc border-radius: 3%;">
  					<table class="table table-striped">
   					...
   					<a  href="javascript:void(0);"  onclick="myfun1(this);" class="click_pop" style="text-decoration:none;" ><input id="test123" type="submit" value="添加考试" style="width:300px;height:60px;margin-left:240px;text-align:center;"></a>
   						<ul><li><%=session.getAttribute("message") %></li></ul>
				</div>
			</div>
			<div id="foot">
				<div id="foot1">
